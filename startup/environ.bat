...
rem set ASSET_PATH=%PROJECT_PATH%/Asset
rem set ANIMATION_PATH=%PROJECT_PATH%/Animation
rem set RENDERING_PATH=%PROJECT_PATH%/Rendering
rem set COMPOSITING_PATH=%PROJECT_PATH%/Composting
rem set DATABASE_PATH=%PROJECT_PATH%/dataBase

set TOOLKIT_PATH=%PACKAGE_PATH%/toolKit
set ICON_PATH=%PACKAGE_PATH%/icons
set BIN_PATH=%PACKAGE_PATH%/bin

rem set PIPEINPUT_FILE=%PACKAGE_PATH%/pipe/pipeInput.json
