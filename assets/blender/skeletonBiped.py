...
class Biped (object):
    ...
    def createSkeleton(self):
        ...
        earA_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (0.5, 0, 11.5), radius=self.jointRadius/2, name='%s_%s'% (self.input._leftSide, self.input._earA))
        earB_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (0.75, 0, 11.5), radius=self.jointRadius/2, name='%s_%s'% (self.input._leftSide, self.input._earB))     
        
        #create eye fit skeleton
        eyeA_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (0.25, -0.75, 12), radius=self.jointRadius/2, name='%s_%s'% (self.input._leftSide, self.input._eyeA))
        eyeB_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (0.25, -1, 12), radius=self.jointRadius/2, name='%s_%s'% (self.input._leftSide, self.input._eyeB))
        ...
        pinkyA_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (4.25, 0.25, 10), radius=self.jointRadius/3, name='%s_%s'% (self.input._leftSide, self.input._pinkyA))    
        pinkyB_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (4.5, 0.25, 10), radius=self.jointRadius/3, name='%s_%s'% (self.input._leftSide, self.input._pinkyB))    
        pinkyC_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (4.7, 0.25, 10), radius=self.jointRadius/3, name='%s_%s'% (self.input._leftSide, self.input._pinkyC))    
        pinkyD_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (4.9, 0.25, 10), radius=self.jointRadius/3, name='%s_%s'% (self.input._leftSide, self.input._pinkyD))    
        pinkyE_contextObject = studioBlender.createEmptyObject ('SPHERE', False, (5.1, 0.25, 10), radius=self.jointRadius/3, name='%s_%s'% (self.input._leftSide, self.input._pinkyE))        
        ...
        self.setHeadHirachey()
        self.setEarHirachey(types=self.input._leftSide)
        self.setEyeHirachey(types=self.input._leftSide)
        self.setArmHirachey(types=self.input._leftSide)
    ...
    def setEarHirachey(self, types=None):
        
        parents = { self.input._earB: self.input._earA,
                    }         
                    
        for eachChild, eachParent in parents.items():            
            studioBlender.setParent('%s_%s'% (types, eachChild), '%s_%s'% (types, eachParent))
       
        studioBlender.setParent('%s_%s'% (types, self.input._earA), self.input._upperJaw)
                            
            
    def setEyeHirachey(self, types=None):
        
        parents = { self.input._eyeB: self.input._eyeA,
                    }         
                    
        for eachChild, eachParent in parents.items():            
            studioBlender.setParent('%s_%s'% (types, eachChild), '%s_%s'% (types, eachParent))            
     
        studioBlender.setParent('%s_%s'% (types, self.input._eyeA), self.input._upperJaw)
        
        
    def setArmHirachey(self, types=None):
